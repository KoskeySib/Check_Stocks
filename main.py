...
TICKER = str(input("Введите тикер акции: "))  # 'TSLA'  # input()
CANDLE_INTERVAL = 4  # Интервалы свечей (0=UNSPECIFIED, 1=1_MIN, 2=5_MIN, 3=15_MIN, 4=HOUR, 5=DAY)
DAYS = 6  # Глубина архива свечей в днях
